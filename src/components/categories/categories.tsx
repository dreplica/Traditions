            ...
            <ul>
                <li>
                    ...
                    <ul className='dropdown' style={{display:drop.women}}>
                        <li><Link to='/sale/women/top/'>Tops</Link></li> 
                        <li><Link to='/sale/women/gown/'>Gown</Link></li>
                        <li><Link to='/sale/women/skirt/'>Skirts</Link></li>
                        <li><Link to='/sale/women/style/'>Style</Link></li>
                    </ul>
                </li>
                <li>
                    <a href="/" id='men' className={drop.men} onClick={handleDrop}>Men's Clothing</a>
                    <ul className='dropdown' style={{display:drop.men}}>
                        <li><Link to='/sale/men/shirt/'>Shirts</Link></li>
                        <li><Link to='/sale/men/trousers/'>Trousers</Link></li>
                        <li><Link to='/sale/men/short/'>Shorts</Link></li>
                        <li><Link to='/sale/men/style/'>Style</Link></li>
                    </ul>
                </li>
                <li>
                    <a href="/" id='access' className={drop.access} onClick={handleDrop}>Accessories</a>
                        <ul className='dropdown' style={{display:drop.access}}>
                        <li><Link to='/sale/access/bangle/'>Bangles</Link></li>
                        <li><Link to='/sale/access/waist_beed/'>Waist beeds</Link></li>
                        <li><Link to='/sale/access/necklace/'>Necklace</Link></li>
                        <li><Link to='/sale/access/ring/'>Rings</Link></li>
                    </ul>
                </li>
                <li>
                    <a href="/" id='wfoot' className={drop.wfoot} onClick={handleDrop}>Women foot wears</a>
                    <ul className='dropdown' style={{display:drop.wfoot}}>
                        <li><Link to='/sale/wfoot/sandal/'>Sandals</Link></li>
                        <li><Link to='/sale/wfoot/hill/'>Hills</Link></li>
                        <li><Link to='/sale/wfoot/shoe/'>Shoes</Link></li>
                    </ul>
                </li>
                <li>
                    <a href="/" id='mfoot' className={drop.mfoot} onClick={handleDrop}>Men foot wears</a>
                    <ul className='dropdown' style={{display:drop.mfoot}}> 
                        <li><Link to='/sale/mfoot/sandal/'>Sandals</Link></li>
                        <li><Link to='/sale/mfoot/shoe/'>Shoes</Link></li>
                    </ul>
                </li>
            </ul>
        </div>
